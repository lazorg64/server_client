...
namespace test
{
	class Client
	{
        ...
        {
            StreamWriter sw = new StreamWriter("C:/Users/Lenovo/Desktop/LEXA/test/Clients.txt", true, Encoding.UTF8);
		...
		{
            StreamReader sr = new StreamReader("C:/Users/Lenovo/Desktop/LEXA/test/Clients.txt", true);
			String check;
